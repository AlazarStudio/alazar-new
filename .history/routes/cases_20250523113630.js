...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      console.log('[BODY]', req.body);
      console.log('[taskDesc]', req.body.taskDesc);
      console.log('[clientDesc]', req.body.clientDesc);
      console.log('[servicesDesc]', req.body.servicesDesc);
